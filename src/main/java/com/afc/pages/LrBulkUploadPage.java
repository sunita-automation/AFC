...
public class LrBulkUploadPage extends AfcDriverHelper {
	...
	public LrBulkUploadPage(WebDriver driver) {
		super(driver);
		// TODO Auto-generated constructor stub
	}

	
	public LrBulkUploadPage selectUploadType(String UploadType)
	  {
	...
	public LrBulkUploadPage clickOnChoseFile() throws Exception
	{
	...
	public LrBulkUploadPage clickOnUploadBtn() throws Exception
	{
		waitfor5sec();
