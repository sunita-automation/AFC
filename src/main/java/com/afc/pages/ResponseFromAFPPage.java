...
public class ResponseFromAFPPage extends AfcDriverHelper  {
	...
	public ResponseFromAFPPage(WebDriver driver) {
		super(driver);
		// TODO Auto-generated constructor stub
	}
	public ResponseFromAFPPage clickOnChoseFile() throws Exception
	{
	...
	public ResponseFromAFPPage clickOnUploadBtn() throws Exception
	{
		waitfor5sec();
