...
public class AfcPropertyReader 
{
...
//	 String xlFilePath;
    ...
    {
    	final File f = new File(new AfcPropertyReader().getFilePath() + "//propertyFile"
                + "//ws123.xls");
    ...
    //Sunita methods
    public String getCellDataXlsx1(String xlfilePath,int sheetindex,int RowNo, int ColNo) throws Exception
	//public String getCellData(int RowNo, int ColNo) throws Exception
    {
