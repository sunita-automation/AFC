...
public class LaborRelationshipBulkUploadCTA_044Test extends AfcTestCaseHelper{
	...
	{
		int i=1;
		UploadType=propertyReader.getCellData(5	, i, 22);
	    path=propertyReader.readTestData("LR_Creation");
	    BatchId=propertyReader.readTestData("LR_creat_batchId");
	    Success=propertyReader.getCellData(5, i, 23);
			...
			propertyReader.updateProperty("LR_creat_batchId", a);
